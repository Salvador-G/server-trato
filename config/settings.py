...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-!89my7j@4b2zxz52%lq-i!jjahdkwe^gk57=l#9-@18=hw@npl')
...
if USE_POSTGRES:
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'trato_db'),
...
# Comentario para probar commits en dokploy :p
